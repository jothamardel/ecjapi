        ...
        <div className="py-8 md:py-12">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center sm:justify-between mb-12 md:mb-6">
            <div className="shrink-0 mr-4">
              {/* Logo */}
              <Link className="inline-flex group mb-8 sm:mb-0" href="/" aria-label="EmpowHer Choices">
                <Image src="/logo/EMPOWHER.png" width={40} height={40} className="object-contain transition-transform duration-200 group-hover:scale-105" alt="EmpowHer Choices Logo" />
              </Link>
            </div>
            <form className="w-full max-w-sm">
              <div className="flex flex-col sm:flex-row justify-center max-w-xs mx-auto sm:max-w-none">
                <input type="email" className="form-input w-full mb-2 sm:mb-0 sm:mr-2 border-gray-300 focus:border-purple-300 focus:ring focus:ring-purple-200 focus:ring-opacity-50" placeholder="Your email" aria-label="Your email" />
                <button className="btn-sm text-white bg-purple-500 hover:bg-purple-600 shadow-sm whitespace-nowrap" type="submit">
          ...
          <div className="text-center md:flex md:items-center md:justify-between mb-8 md:mb-6">
            ...
            <ul className="inline-flex mb-4 md:order-2 md:ml-4 md:mb-0">
              <li>
                <a
                  className="flex justify-center items-center text-purple-500 bg-purple-100 hover:text-white hover:bg-purple-500 rounded-full transition duration-150 ease-in-out"
                  href="#0"
                  aria-label="Twitter"
                >
            ...
            <div className="text-sm font-medium md:order-1 space-x-6 mb-2 md:mb-0">
              ...
              <Link className="text-gray-500 decoration-purple-500 decoration-2 underline-offset-2 hover:underline" href="/contact-us">
                Contact Us
              </Link>
            </div>
          </div>
