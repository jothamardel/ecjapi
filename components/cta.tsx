      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-8">
          ...
          <div className="relative py-12 px-8 md:py-20 md:px-12">
            {/* Dark box */}
            <div className="absolute inset-0 bg-purple-600 -rotate-2 -z-10" aria-hidden="true" />
            <div className="flex flex-col lg:flex-row justify-between items-center">
              ...
              <div className="relative mb-6 lg:mr-16 lg:mb-0 text-center lg:text-left">
                ...
                <h3 className="h2 font-cabinet-grotesk text-gray-100">
                  Support the{' '}
                  <span className="relative inline-flex text-yellow-300">
                    Padded Girl Program
                    <svg className="absolute left-0 top-full -mt-2 w-full max-w-full -z-10" width="320" height="14" viewBox="0 0 320 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M5 8C80 4 180 3 270 7C295 8 310 11 315 9" stroke="#FBBF24" strokeWidth="4" strokeLinecap="round" />
                    </svg>
                  </span>{' '}
                  today!
                </h3>
              ...
              <div className="shrink-0">
                <Link className="btn text-purple-900 bg-yellow-400 hover:bg-yellow-500 w-full shadow-sm font-bold" href="/donate">
                  Donate Now
                </Link>
              </div>
            </div>
