                ...
                <div className="swiper-wrapper">
                  ...
                  <div className="swiper-slide space-y-8 lg:flex items-center lg:space-y-0 lg:space-x-8 text-center lg:text-left">
                    <div className="shrink-0 relative inline-flex">
                      <div className="relative w-[280px] h-[280px] rounded-full overflow-hidden border-4 border-white shadow-lg">
                        <Image className="object-cover" src="/new_stills/rawuta_instagram.jpg" fill alt="Ms. Rawuta Bishara" />
                      </div>
                      <div className="absolute right-0 bottom-0 mr-4 mb-6">
                        <span className="flex items-center font-cabinet-grotesk font-bold px-3 py-1 bg-white rounded-full shadow-sm text-sm text-purple-600 border border-purple-100">
                          Stablehand Graduate
                        </span>
                      </div>
                    </div>
                  ...
                  <div className="swiper-slide space-y-8 lg:flex items-center lg:space-y-0 lg:space-x-8 text-center lg:text-left">
                    ...
                    <div className="relative">
                      ...
                      <h4 className="h3 font-cabinet-grotesk mb-4 text-gray-900">
                        "Partnering with ECJAPI on the Padded Girl Campaign has been incredibly rewarding. We are breaking barriers around menstrual hygiene, teaching consent, and dismantling rape culture in schools."
                      </h4>
                      <div className="font-bold text-gray-800 text-lg">Ms. Felicia Samson</div>
                      <div className="text-purple-500 font-medium text-xs">Med Lab Scientist, Plateau Specialist Hospital (TVAII)</div>
                    </div>
                  </div>
                  ...
                  <div className="swiper-slide space-y-8 lg:flex items-center lg:space-y-0 lg:space-x-8 text-center lg:text-left">
                    <div className="shrink-0 relative inline-flex">
                      <Image className="rounded-full" src={TestimonialsImage03} width={280} height={280} alt="Amina" />
                      <div className="absolute right-0 bottom-0 mr-4 mb-6">
                        <span className="flex items-center font-cabinet-grotesk font-bold px-3 py-1 bg-white rounded-full shadow-sm text-sm text-purple-600 border border-purple-100">
                          STEM Student
                        </span>
                    ...
                    <div className="relative">
                      ...
                      <h4 className="h3 font-cabinet-grotesk mb-4 text-gray-900">
                        "I want to study aeronautical engineering and build spaceships! Thanks to the STEM classes and computer literacy programs at ECJAPI, I feel confident and ready to pursue my dream."
                      </h4>
                      <div className="font-bold text-gray-800 text-lg">Amina</div>
                      <div className="text-purple-500 font-medium text-xs">STEM Program Student (Age 14)</div>
                    </div>
                  </div>
                </div>
              </div>
